...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MAC_NAV] = LAYOUT_4key_2u_inner(
    ...
    _______,KC_HOME,KC_LEFT,KC_DOWN,KC_RGHT,KC_END, W_BASE,     TO_GAME,_______,C_LEFT, C_UP,   C_RGHT, KC_PAUS,KC__VOLUP,
    RGB_VAI,_______,C_LEFT, C_UP,   C_RGHT, _______,_______,    _______,_______,_______,_______,_______,KC_SLCK,KC__VOLDOWN,
    RGB_VAD,_______,_______,_______,XXXXXXX,SP_ENT, ALT_UDS,    _______,_______,_______,_______,_______,_______,KC__MUTE
    ),
  ...
  [WIN_NAV] = LAYOUT_4key_2u_inner(
    ...
    _______,KC_HOME,KC_LEFT,KC_DOWN,KC_RGHT,KC_END, M_BASE,     TO_GAME,_______,W_LSCR, W_TASK, W_RSCR, KC_PAUS,KC_VOLU,
